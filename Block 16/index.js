...
console.log(`Timmy's grand total is $${calculateTotal(timmy)}.`);
console.log(`Sarah's grand total is $${calculateTotal(sarah)}.`);
console.log(`Rocky's grand total is $${calculateTotal(rocky)}.`);